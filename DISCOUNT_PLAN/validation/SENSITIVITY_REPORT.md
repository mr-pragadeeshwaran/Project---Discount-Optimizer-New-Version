...
*Run `20260705_161703` · 63 waste-cut cells x 200 Monte-Carlo draws (seed 42). No per-draw refits: the champion is fit once for its coefficient uncertainty; each draw re-scores the decision rule analytically.*
