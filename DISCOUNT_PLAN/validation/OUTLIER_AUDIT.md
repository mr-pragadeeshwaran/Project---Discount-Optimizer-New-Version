...
*Run `20260705_161703` · 3129 outlier days removed by the |z|>2.0 filter, cross-checked against the festival calendar, platform-event windows, stock-outs, and each cell's own promo depth. ADVISORY: this audits the filter, it does not change it — the champion's training data stays exactly as validated.*
